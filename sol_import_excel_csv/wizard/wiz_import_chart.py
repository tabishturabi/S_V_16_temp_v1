...
# ------------------------------------------------------------						
	...
	def create_chart_accounts(self,values):
		...
		account_type = self.find_user_type(values.get('user'))
		...
		parent_id = self.find_parent_id(values.get('parent_id'))
...
# ------------tags
		...
		# Migration Note
		# 'user_type_id': user_id.id replaced with account_type
		data={
				'code' : code_no,
...
# ---------------------------parent-----------------
	...
	# @api.multi
	def find_parent_id(self,parent):
		accounts=self.env['account.account']
		parent_search = accounts.search([('code','=',parent)])
		if parent_search:
