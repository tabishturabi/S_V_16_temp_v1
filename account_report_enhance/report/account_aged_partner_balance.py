    ...
    def _get_partner_move_lines(self, account_type, date_from, target_move, period_length):
        ...
        for partner in partners:
            ...
            if partner['partner_id']:
                ...
                browsed_partner = self.env['res.partner'].sudo().with_context(force_company=self.env.user.company_id.id, company_id=self.env.user.company_id.id).browse(partner['partner_id'])
                values['name'] = browsed_partner.display_name and len(browsed_partner.display_name) >= 100 and browsed_partner.display_name[0:90] + '...' or browsed_partner.display_name
