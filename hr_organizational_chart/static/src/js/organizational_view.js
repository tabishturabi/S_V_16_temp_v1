...
//        this.$el.html(QWeb.render("org_emp_chart", {widget: this}));
        this.renderEmployeeDetails();
    },
    render: function() {
        var super_render = this._super;
        var self = this;
        var org_chart = QWeb.render('org_emp_chart', {
            widget: self,
        });
    ...
    return EmployeeOrganizationalChart
