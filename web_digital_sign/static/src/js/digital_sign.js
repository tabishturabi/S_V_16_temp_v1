...
//        placeholder: this.model == 'bassami.inspection' && '/bassami_inspection/static/src/img/car.png'  || "/web/static/src/img/placeholder.png",
...
//            if (typeof signature !== "undefined" && signature[1]) {
...
//                            self.$('.signature > canvas').remove();
//                            self.$('.signature').prepend('<img src="data:image/png;base64,' + data[0].digital_signature+'" src="theImg.png" />');
//                            //var field_desc = _.values(_.pick(data[0], field_name));
//                            // self.$(".signature").jSignature("clear");
//                            // self.$(".signature").jSignature("setData", 'data:image/png;base64,' + data[0].digital_signature);
//                        }
//                    });
//                } else {
//                   // this.$('> img').remove();
//                    this.$('.signature > img').remove();
//                    var sign_options = {
//                        'decor-color': '#D1D0CE',
//                        'color': '#000',
//                        'background-color': '#fff',
...
//                    };
//                    this._on_clear_sign()
//                  //  console.log(">>>EDITTT>",this.$(".signature"))
...
//              //  this.$('> canvas').remove();
//                if (!this.value) {
//                    this.$(".signature").jSignature("init", {
//                        'decor-color': '#D1D0CE',
//                        'color': '#000',
//                        'background-color': '#fff',
//                        'height': '180',
