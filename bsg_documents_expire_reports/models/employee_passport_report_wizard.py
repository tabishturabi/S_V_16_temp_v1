...
class EmployeePassportReportWizard(models.TransientModel):
    _name = 'employee.passport.report.wizard'
    ...
    def click_print_excel(self):
        ...
        return self.env.ref('bsg_documents_expire_reports.employee_passport_report_xlsx_id').report_action(self,data=data)
    ...
    def click_print_pdf(self):
        ...
        return self.env.ref('bsg_documents_expire_reports.employee_passport_report_pdf_id').report_action(self,data=data)

    # @api.multi
    def get_notification(self):
        data = self.read()
        report = self.env['ir.actions.report']. \
            _get_report_from_name('bsg_documents_expire_reports.passport_report_xlsx')
